...
export default async function FeaturedBooks() {
    const data = await wpFetch<BooksData>(QUERY, { first: 3 });

    return (
        <div className="featured-books">
            <div className="flex items-center justify-between mb-6">
                <h2 className="text-3xl font-bold flex items-center">Featured Books</h2>
                <Link href={`/books`} className="flex items-center">See More</Link>
            </div>
